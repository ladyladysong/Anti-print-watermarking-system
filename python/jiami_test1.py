...
#计算m 嵌入水印信息的参数
def cal_K(img,line_ranges,vertical_line_ranges2d,wi,str1):
    global K
    count = 0   #所有的字符
    #NA,NB 字符图像个数
    ...
    for i in range(len(sum_img1)):
        img1 = sum_img1[i]
        change_all.append(embedInfo(img1,m))
...
def pic(thresh1):
    ...
    cal_K(thresh1,line_ranges,vertical_line_ranges2d,wi,str1)
