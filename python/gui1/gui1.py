...
###########################################################################
	...
	def MyPanel2( self ):
		...
		m_comboBox1Choices = [ u"醉翁亭记", u"小石潭记", u"放鹤亭记", u"石钟山记",u"口技",u"前赤壁赋",u"岳阳楼记",u"核舟记"]
	...
	def click_next2( self, event ):
		#self.Warning_window()
		c = en_main1.cuttt(self.cc_e,self.pic)
		f = c.judge()
	...
	def Warning_window(self):
		self.warn_panel = wx.MessageBox(u"提示！文本长度过长，嵌入不完全","Warning",wx.OK|wx.ICON_EXCLAMATION)		
	...
	def MyPanel4( self ):
		...
		m_comboBox2Choices = [ u"醉翁亭记", u"小石潭记", u"放鹤亭记", u"石钟山记",u"口技",u"前赤壁赋",u"岳阳楼记",u"核舟记"]
...
#！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
	...
	def click_sure(self,event):
		...
		f.close()
		d = de_main1.extracttt(self.w_po,self.pic_d)
		self.wii = d.output1()
		info1 = self.wii
		#简单同位加密操作
		i = 0
